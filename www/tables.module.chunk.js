...
var DataTableComponent = (function () {
    ...
    DataTableComponent.prototype.editUsuario = function (userId) {
        var _this = this;
        this.userService.getUserById(+userId).subscribe(function (userResponse) {
            localStorage.setItem("currentIdUserEdit", JSON.parse(JSON.parse(JSON.stringify(userResponse))._body).userId);
            _this.router.navigate(['/forms/edicao-usuario']);
        }, function (error) { return console.log(error); });
    };
