...
// module
exports.push([module.i, ".card [data-background-color=\"imersa\"] {\n    background: linear-gradient(60deg, #a3dbc9, #00ffad);\n    box-shadow: 0 4px 20px 0px rgba(0, 0, 0, 0.14), 0 7px 10px -5px rgba(233, 30, 99, 0.4);\n}\n\n.card-login .social-line {\n    margin-top: -10px;\n    text-align: center;\n    padding: 0;\n}\n\n.row[_ngcontent-c0] {\n    margin-right: 15px;\n    margin-left: 0px;\n}\n", ""]);
...
module.exports = "<div class=\"wrapper wrapper-full-page\">\n    <div class=\"full-page login-page\" >\n        <!--  you can change the color of the filter page using: data-color=\"blue | purple | green | orange | red | rose \" -->\n        <div class=\"content\">\n            <div class=\"container\">\n                <div class=\"row\">\n                    <div class=\"col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3\" style=\"padding-right: 0 !important;\">\n                        <form (ngSubmit)=\"onSubmit()\">\n                            <div class=\"card card-login card-hidden\">\n                                <div class=\"card-header text-center\" data-background-color=\"imersa\">\n                                    <h4 class=\"card-title\"> </h4>\n                                    <div class=\"social-line\">\n                                          <img src=\"assets/img/imersa-logo.png\" style=\"height:150px; width:150px;\"/>\n                                    </div>\n                                </div>\n                                <p class=\"category text-center\">\n                                    Faça login aqui\n                                </p>\n                                <div class=\"card-content\">\n                                    <div class=\"input-group\">\n                                        <span class=\"input-group-addon\">\n                                            <i class=\"material-icons\">email</i>\n                                        </span>\n                                        <div class=\"form-group label-floating\">\n                                            <label class=\"control-label\">Endereço de email</label>\n                                            <input type=\"email\" class=\"form-control\"  [(ngModel)]=\"model.email\"   name='email' >\n                                        </div>\n                                    </div>\n                                    <div class=\"input-group\">\n                                        <span class=\"input-group-addon\">\n                                            <i class=\"material-icons\">lock_outline</i>\n                                        </span>\n                                        <div class=\"form-group label-floating\">\n                                            <label class=\"control-label\">Senha</label>\n                                            <input type=\"password\" class=\"form-control\"  [(ngModel)]=\"model.password\"  name='password'>\n                                        </div>\n                                    </div>\n                                </div>\n                                <div class=\"footer text-center\">\n                                    <button type=\"submit\" class=\"btn btn-rose btn-simple btn-wd btn-lg\">Entrar</button>\n                                </div>\n                            </div>\n                        </form>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <footer class=\"footer\">\n            <div class=\"container\">\n                <p class=\"copyright pull-right\">\n                    &copy;\n                    {{test | date: 'yyyy'}}\n                    <a href=\"#\">YKS-Sistemas</a>, feito com amor equipe dev..\n                </p>\n            </div>\n        </footer>\n        <div class=\"full-page-background\" style=\"background-image: url(../../../assets/img/login-imersa-2.png) \"></div>\n    </div>\n</div>\n"
...
var LoginComponent = (function () {
    function LoginComponent(element, loginService, userService, router, localStorageService) {
        ...
        this.test = new Date();
        this.model = { 'email': '', 'password': '', 'isAdmin': '' };
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        this.loginService.sendCredential(this.model).subscribe(function (data) {
            ...
            _this.loginService.sendToken(localStorage.getItem("token")).subscribe(function (data) {
                _this.currentEmail = _this.model.email;
                _this.currentIsAdmin = _this.model.isAdmin;
                localStorage.setItem("currentEmail", _this.model.email);
                _this.userService.getUserByEmail(localStorage.getItem("currentEmail")).subscribe(function (user) {
                    _this.user = JSON.parse(JSON.parse(JSON.stringify(user))._body);
                    _this.loginService.userLogado = _this.user;
                    _this.localStorageService.userLogado = _this.user;
                    console.log(_this.localStorageService.userLogado);
                    var tostring = "";
    ...
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__services_login_service__["a" /* LoginService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_login_service__["a" /* LoginService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__services_user_service__["a" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_user_service__["a" /* UserService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4__services_local_storage_service__["a" /* LocalStorageService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__services_local_storage_service__["a" /* LocalStorageService */]) === "function" && _e || Object])
    ], LoginComponent);
